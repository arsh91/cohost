	...
	foreach($mails as $val){
		...
		if($emailLink != ""){   
			...
			foreach($codes as $code){
				 $ycode = $code["code"];echo "<br>";
				$cohostId=$code["Id"];
			

				if ($ycode !='' && strpos($shortbody, $ycode) !== false){
				echo "yesy";echo "<br>";
				// echo $responsethreadNo;
				...
				if(!empty($ID)) {
					foreach( $ID as $id){  
						...
						$responseSpeed= (strtotime($responsedattime) - strtotime($simpledatetime))/60;
							...
							echo $responseDate; echo "<br>";
							echo $responseTime; echo "<br>";
							echo $pClass; echo "<br>";
							echo $val; echo "<br>";
							echo $id["Id"]; echo "<br>";
							echo $responsethreadNo; echo "<br>";
